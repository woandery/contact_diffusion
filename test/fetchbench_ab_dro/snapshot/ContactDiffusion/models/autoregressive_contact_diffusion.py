...
class AutoregressiveContactDiffusion(nn.Module):
    ...
    def forward(
        ...
        surface_pc: Optional[torch.Tensor] = None,
    ...
    def training_step(
        ...
        surface_pc = object_pc if surface_pc is None else surface_pc
        ...
        if self.symmetric_all_first:
            ...
            expanded_surface_pc = surface_pc.repeat_interleave(num_contacts, dim=0)
            ...
            expanded_surface_pc = surface_pc
        ...
        nearest_surface_mm = torch.cdist(
            target_pred[..., :3], expanded_surface_pc[..., :3]
    ...
    def trajectory_training_step(
        ...
        for position in range(num_contacts):
            ...
            surface_errors.append(
                torch.cdist(target_pred[..., :3], expanded_surface_pc[..., :3]).amin(
                    dim=(1, 2)
                )
                * mm_scale
            )
