...
FK200_ENV200_PROTOCOL_ID = (
    "contactdiff-multidex45k-fk64x32-fk200-env200-dro-gym-v1"
)
CANDLE111_S8P8_FK200_ENV200_HIGHLR_PROTOCOL_ID = (
    "contactdiff-candle111-s8p8-fk200-lr0075-env200-lr003-nopalm-v1"
)
EXTENSION3_S4P4_FK200_ENV200_PROTOCOL_ID = (
    "extension3-ab-s4p4-dro64-fk200-env200-w10-20260910"
)
